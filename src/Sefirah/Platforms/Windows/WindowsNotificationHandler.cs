...
public class WindowsNotificationHandler(ILogger logger) : IPlatformNotificationHandler
{
    ...
    /// <inheritdoc />
    public async Task ShowSimpleNotification(string title, string text, string? iconPath = null)
    {
        try
        {
            var builder = new AppNotificationBuilder()
    ...
    /// <inheritdoc />
    public async Task ShowClipboardNotification(string title, string text, string? actionLabel = null, string? actionData = null)
    {
        try
        {
            var builder = new AppNotificationBuilder()
